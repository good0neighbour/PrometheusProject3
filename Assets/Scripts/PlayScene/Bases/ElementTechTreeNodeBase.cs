...
public class ElementTechTreeNodeBase : MonoBehaviour
{
    /* ==================== Variables ==================== */
    ...
    private ElementTechTreeViewBase _popUpView = null;
    ...
    {
        _popUpView.NodeSelected(_nodeNum);
    }
    ...
    /// 노드 초기화
    /// </summary>
    public void SetNode(byte nodeNum, TechTreeType techTreeType, ElementTechTreeViewBase popUpView)
    {
        // 노드 번호 설정
        _nodeNum = nodeNum;
