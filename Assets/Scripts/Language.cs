    ...
    private struct JsonLanguage
    {
        ...
        public JsonLanguage(bool initialize)
        {
            Texts = new string[]
            {
                ...
                "의제 없음",
                "기후 변화",
                "지구 평균 기온 상승에 의해 지구의 기후 패턴이 급격하게 변화하면서 화석 연료 사용에 대한 문제가 대두되었습니다. 세계는 화석 연료를 사용하지 않는 기술의 연구, 개발에 많은 투자를 하게 됩니다. 이러한 기술은 훗날 인류가 외계 행성에 정착할 때 생산 활동에 도움을 줍니다. 시작 시 연간 수익이 증가합니다.",
                "환경 파괴",
                "대기, 토양, 물 등에 오염물질이 유출되면서 자연 환경과 생태계가 파괴되는 문제가 발생했습니다. 세계는 문제의 원인을 화석 연료를 주 원료로 사용하는 플라스틱에 두었고, 플라스틱을 대체할 소재를 개발하는데 노력하게 됩니다. 이러한 노력은 훗날 인류가 외계 행성에 정착할 때 자원 활용에 도움을 줍니다. 시작 시 연구량이 증가합니다.",
                "자원 고갈",
                "19세기 경부터 인류 문명은 화석 연료에 크게 의지하는 형태로 발전해왔으나 화석 연료가 형성되는 속도보다 고갈되는 속도가 더 빨라지면서 자원 고갈 문제가 제기되었습니다. 세계는 천연 자원 및 재생 에너지 사용을 위해 노력하게 됩니다. 이러한 노력은 훗날 인류가 외계 행성에 정착할 때 자원 사용에 도움을 줍니다. 시작 시 자원량이 증가합니다.",
                "문화잠식",
                "문화강탈",
                "문화공정",
                "음악 공연",
                ...
                "극단적 채식주의 선동",
                "정의라는 단어로 위장하여 극단적인 동물 보호를 위해 평범한 식욕을 가진 인간을 희생합니다. 동물에 대한 폭력을 막기 위해 인간에게 폭언, 폭행을 가하며 해당 국가에 내부갈등을 유발합니다.",
                "약자 혐오 선동",
